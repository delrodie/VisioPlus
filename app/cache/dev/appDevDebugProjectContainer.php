...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'visioplus', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Abloqov\\VisioplusBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Abloqov\\UtilisateurBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Abloqov\\VisioplusBundle\\Entity');
        $c->addDriver($b, 'Abloqov\\UtilisateurBundle\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array(($this->targetDirs[3].'\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\doctrine\\model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AbloqovVisioplusBundle' => 'Abloqov\\VisioplusBundle\\Entity', 'AbloqovUtilisateurBundle' => 'Abloqov\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_acc337cc09052c03ead13ff2fe29d07d63be0901acc2ee83a6a896ab23f95652');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Abloqov\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Abloqov\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Abloqov\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Abloqov\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Abloqov\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register/');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/change-password');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/marque.*');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/monture.*');
        ...
        $t->add($m, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $t->add($n, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $t->add($o, array(0 => 'ROLE_ADMIN'), NULL);
        $t->add($p, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $w->setOptions(array('login_path' => '/login', 'default_target_path' => '/marque/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($t, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $v, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $u, 'main', $w, $x, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55029420d915e', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $t, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $u, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $u, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Abloqov\\VisioplusBundle/Resources/views'), 'AbloqovVisioplus');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\bundles\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Abloqov\\UtilisateurBundle/Resources/views'), 'AbloqovUtilisateur');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ade543576cdfeb6fe6c9c8e6d4668465a6c7d8bd');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\validation.xml')));
        ...
        $instance->addXmlMapping(($this->targetDirs[3].'\\vendor\\bundles\\FOS\\UserBundle\\DependencyInjection\\Compiler/../../Resources/config/validation/orm.xml'));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPERADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AbloqovVisioplusBundle' => 'Abloqov\\VisioplusBundle\\AbloqovVisioplusBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'AbloqovUtilisateurBundle' => 'Abloqov\\UtilisateurBundle\\AbloqovUtilisateurBundle',
            ...
            'locale' => 'en',
            'secret' => 'ade543576cdfeb6fe6c9c8e6d4668465a6c7d8bd',
            ...
            'kernel.secret' => 'ade543576cdfeb6fe6c9c8e6d4668465a6c7d8bd',
            ...
            'fos_user.model.user.class' => 'Abloqov\\UtilisateurBundle\\Entity\\Utilisateur',
