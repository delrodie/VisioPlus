...
class __TwigTemplate_2a3402605f4987efd70473f241edf2abacf4017e26f5c7dcaaa7fe97a3f98796 extends Twig_Template
{
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session", array()), "get", array(0 => "flashes"), "method"));
        foreach ($context['_seq'] as $context["key"] => $context["flash"]) {
            // line 12
            echo "        <div class=\"";
            echo twig_escape_filter($this->env, (isset($context["fash"]) ? $context["fash"] : $this->getContext($context, "fash")), "html", null, true);
            echo "\">
            ";
            // line 13
