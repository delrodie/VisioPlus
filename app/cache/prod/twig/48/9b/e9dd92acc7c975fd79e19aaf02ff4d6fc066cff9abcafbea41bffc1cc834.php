...
";
 ...
 <div class=\"grid_10\">
                ...
                <h1>GESTION DES MARQUES DE MONTURES</h1>
                    ...
                    \t<tr>
                            ...
                            <td class=\"text-input\">
                                ";
        // line 78
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["marque"]) ? $context["marque"] : null), "libelle", array()), "html", null, true);
        echo "
                            </td>
        ...
        echo "\"><i class=\"icon-undo\"></i> Retour à la liste des marques</a>
                    ...
                    ";
        // line 95
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("AbloqovVisioplusBundle:Monture:liste", array("id" => $this->getAttribute((isset($context["marque"]) ? $context["marque"] : null), "id", array()))));
        echo "
